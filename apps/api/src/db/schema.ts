...
export const parseMethodEnum = pgEnum("parse_method", [
  "ATS_API",
  "HTML",
  "LLM_FALLBACK",
]);
...
export const applications = pgTable("applications", {
  ...
  interviewingAt: timestamp("interviewing_at", { withTimezone: true }),
...
// User Alerts table — keyword-driven email/Slack alerts on JOB_DISCOVERED
