                        ...
                        {companies.map(company => (
                            <div key={company.id} className="glass-card" style={{ padding: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                                ...
                                <div style={{ display: 'flex', gap: '0.5rem', marginTop: 'auto', paddingTop: '0.5rem', borderTop: '1px solid var(--glass-border)' }}>
                                    <Link href={`/companies/${company.id}`} className="btn" style={{ flex: 1, fontSize: '0.78rem', padding: '0.35rem', textAlign: 'center', background: 'transparent', border: '1px solid var(--glass-border)' }}>
                                        View Jobs
                                    </Link>
                                    <button
                                        className="btn"
                                    ...
                                    <button
                                        ...
                                        style={{ fontSize: '0.78rem', padding: '0.35rem 0.6rem', background: 'transparent', border: '1px solid rgba(239,68,68,0.3)', color: '#ef4444' }}
                                    >
                                        ✕
                                    </button>
                                </div>
